...
import {BLOG_SERVER_URL, USER_SERVER_URL} from "../../config/Config";
import PostSeparateViewModel from "../../view_models/PostSeparateViewModel";
...
export const Profile = (props) => {
    ...
    useEffect(() => {
        ...
        Axios.post(`${USER_SERVER_URL}/getProfile`, profile_params)
            .then(response => {
