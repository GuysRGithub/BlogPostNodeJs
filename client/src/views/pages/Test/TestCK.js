...
export default function NewTestCK() {
        return (
            <div>
                <header>
                    ...
                    <div className="centered">
                        <div className="row row-editor">
                            <div className="editor">
                                ...
                                <figure className="image image-style-side"><img src="https://c.cksource.com/a/1/img/docs/sample-image-bilingual-personality-disorder.jpg" />
