...
function ShowBlogPage(props) {
    ...
    return (<div>
            ...
            <div className="row mx-lg-4">
                <main id="main" className="col-8 fs-3 fw-4 pr-4">
                    ...
                    <aside><h2
                        ...
                        <ul className="list-unstyled fs-1 list-spacing-1 list-line-break fs-1-2">
                            <li className="recentcomments">
                                ...
                                href="https://appetitedemo.wordpress.com/2015/07/08/how-to-make-sushi-at-home/#comment-15">How
                                to Make Sushi at&nbsp;Home</a></li>

                            <li className="recentcomments">
                                Julia Doe on <a
                                href="https://appetitedemo.wordpress.com/2015/07/08/how-to-make-sushi-at-home/#comment-14">How
                                to Make Sushi at&nbsp;Home</a></li>

                            <li className="recentcomments">
                                Taras Dashkevych on <a
                                href="https://appetitedemo.wordpress.com/2015/07/08/how-to-make-sushi-at-home/#comment-13">How
                                to Make Sushi at&nbsp;Home</a></li>
